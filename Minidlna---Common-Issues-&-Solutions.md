...
It's a bit dated and doesn't include the swapfile creation step.  You can still use that, but then you'll seed to manually set up the swap file using something like this:   
