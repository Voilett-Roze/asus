...
ACCOUNT\_ID="123456789"        # Replace with your account ID
ZONE\_ID="yourzone.id"  # The zone ID is the name of the zone (or domain)
RECORD\_ID="123456789"       # Replace with the Record ID
IP=${1}
