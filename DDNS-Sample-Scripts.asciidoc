...
RECORDID= #Find it using browser's Network tab while on your domain's DNS page on DigitalOcean or use the API
DOMAIN=example.com
IP=${1}
...
curl \
  ...
  -d "{\"data\":\"$IP\"}" "https://api.digitalocean.com/v2/domains/$DOMAIN/records/$RECORDID" \
