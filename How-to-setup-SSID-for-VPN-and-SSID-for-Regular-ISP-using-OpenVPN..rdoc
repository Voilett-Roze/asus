= YazFi Addon
One of the features of the YazFi addon is to set up a guest network to redirect to a VPN client on the router. Read more here: https://www.snbforums.com/threads/yazfi-v4-x.70308/
