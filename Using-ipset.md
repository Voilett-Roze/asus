...
Newer router has [ipset version 6](http://ipset.netfilter.org/ipset.man.html) while older routers has [ipset version 4](http://ipset.netfilter.org/iptables.man.html), consult the chart below to see your ipset version.
